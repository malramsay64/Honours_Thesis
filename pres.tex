...
\begin{frame}{Two Phase \tri}
    \noindent\makebox[\columnwidth]{\includegraphics[width=\paperwidth]{tri-start}}
    \noindent\makebox[\columnwidth]{\includegraphics[width=\paperwidth]{tri-end}}
\end{frame}
...
\begin{frame}{Nucleation}
    \vspace{-3pt}
    \animategraphics[width=\linewidth]{12}{presentation/movie/}{0001}{0001}% replace with 0333
\end{frame}
