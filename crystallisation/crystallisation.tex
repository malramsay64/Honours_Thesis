...
\begin{figure}
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{{{Snowman-0.637556-1.0-p3}}}
        \caption{p3}
        \label{fig:sone p3}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{{{Snowman-0.637556-1.0-p2gg}}}
        \caption{p2gg}
        \label{fig:sone p2gg}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{{{Snowman-0.637556-1.0-pg}}}
        \caption{pg}
        \label{fig:sone pg}
    \end{subfigure}
